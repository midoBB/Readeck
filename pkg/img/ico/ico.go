// SPDX-FileCopyrightText: © 2016 Markus zyxar
//
...
// Decode returns the first image contained in the icon
...
// DecodeConfig returns dimensions of the first image
// contained in the icon without decoding the entire icon file.
